...
def Voting_Ensembles(train_A, train_words_of_tweets, train_extra_features, test_words_of_tweets, test_A, test_extra_features):
...
#######################################################################################################################
    ...
    model = VotingClassifier(estimators=[('svm1', class1), ('svm2', class2), ('svm3', class3), ('svm4', class4), ('kneigh', class5), ('bern', class6)], voting='hard')

#######################################################################################################################
    '''
    # Learning Curve

    title = "Learning Curves (Voting Ensembles)"
